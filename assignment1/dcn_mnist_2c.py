...
def main():
    ...
    result_2b = './results_2c/' # directory where the results from the training are saved
    result_2b_test = './results_2c_test/'
    ...
    # pick gradient descent for the new training method
